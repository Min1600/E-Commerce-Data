...
4. For the analysis on delivery time, estimated delivery time and reviews scores. The orders that arrived earlier than estimated had lower average delivery time and orders that arrived later than estimated had on average longer delivery times, this could effect the reviews score as a faster delivery time has been shown to positively effect review scores.
   ...
   After trying to equalize delivery time for both the fast early with fast late deliveries and slow early with slow late deliveries, the median reviews scores remained the same. So the correlation still stands, that estimated time effects reviews score even when keeping delivery time consistent. In the data and graphs I did not filter out the differences in delivery time but it is true that when delivery times come ealier than estimated average delivery time is lower vice versa for orders that come later than estimated.
